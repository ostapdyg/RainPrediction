...
```
Choose more or less independent values
```{r}
final_data = data[, c("Pressure9am","PressureDiff",
                      "TempRange","Temp9am",
                      "Humidity9am","HumidityDiff",
                      "WindGustSpeed",
                      "RainTodayNum", "RainTomorrowNum")]

ggcorrplot(corr=cor(final_data),hc.order = TRUE, method="square", lab = TRUE, lab_size = 2)
